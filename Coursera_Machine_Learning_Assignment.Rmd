...
For this project I have used FOUR different models to figure out the one with maximum accuracy out of sample dataset. Following are the FOUR models I am going to use:
